 ...
 const Testimonial = (props) => {
  ...
  return (
    <div className=' w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center
        ...
        <div className=' flex text-3xl mt-5 text-violet-400 gap-3 font-bold mx-auto '>
        ...
        <div className='mt-6'>
            <button onClick={supriseHandler} className=' bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer
